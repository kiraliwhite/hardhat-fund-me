...
contract FundMe {
    ...
    uint256 public constant MINIUSD = 10 * 1e18;
    address[] private funders;
    mapping(address => uint256) private fundMoney;
    ...
    function traFromContract(address payable _to, uint256 _value)
        public
        onlyOwner
    {
        _to.transfer(_value);
    ...
    function sendFromContract(address payable _to, uint256 _value)
        public
        onlyOwner
    {
    ...
    function callFromContract(address payable _to, uint256 _value)
        public
        onlyOwner
    {
    ...
    function getFunderMoney(address _funder) public view returns (uint256) {
